...
{
    /// <summary>
    /// The Package class holds all relevant information from a single package in a .pcap file created by Wireshark. As well as functionality to convert it from .csv files generated by TShark
    /// </summary>
